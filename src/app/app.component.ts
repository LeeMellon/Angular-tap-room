...
export class AppComponent {
  title = 'Tap Room';
  masterKegList: Keg[] = [
    new Keg("Shiner Bock", "Shiner Co.", "6.00", "4.6","https://lh3.googleusercontent.com/gfiTR3LQOBtYyZUklBwL7IX-_wMJTYDhKETXGY1qyqK6P2ARWliQkFdKxh3uWzqChCeisYrlm9H_kux2lI0M5jSUjacG_A=s750", 124),
